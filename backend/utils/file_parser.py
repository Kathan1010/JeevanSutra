...
class FileParser:
    ...
    LAB_ALIASES = {
        ...
        "bil": "bilirubin", "bilirubin": "bilirubin", "total bilirubin": "bilirubin", "bilirubin (total)": "bilirubin",
        "plt": "platelets", "platelets": "platelets", "platelet count": "platelets",
        "wbc": "wbc", "white blood cell": "wbc", "leucocyte": "wbc", "wbc count": "wbc",
        "hb": "hemoglobin", "hgb": "hemoglobin", "hemoglobin": "hemoglobin",
        "glu": "glucose", "glucose": "glucose", "blood sugar": "glucose", "rbs": "glucose",
        "lac": "lactate", "lactate": "lactate", "lactate (arterial)": "lactate",
        "ph": "pH", "blood ph": "pH",
    ...
    VITAL_ALIASES = {
        ...
        "blood pressure": "systolic_bp", # The regex will grab the first number (systolic)
        ...
        "fio2": "fio2",
        "gcs": "gcs_total", "glasgow": "gcs_total", "gcs score": "gcs_total",
        "peep": "peep",
